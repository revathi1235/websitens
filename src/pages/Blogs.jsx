...
function Blogs() {
  return (
    <div>
         <div className='inventorymanagement-starting'>
    ...
    <Container>
        <Row>
            <Col lg={3}></Col>
            <Col lg={6}>
            <p className='blog-para'>Join our community of industry leaders to discover quick and innovative ideas that will elevate your brand</p>
