...
<div className='firstdiv-multichannelintegration ' >
    ...
    <div className='multichannelintegration-content'>
      <h2 >Inventory Management </h2>
        <p style={{textAlign:"justify",padding:"40px"}}>PURVEY WMS provides real-time visibility into your inventory, allowing you to monitor stock levels, track movement, and make informed decisions. You can easily view the quantity, location, and status of each item, ensuring accurate stock management and minimizing stockouts.</p>
    </div>
   </div>
